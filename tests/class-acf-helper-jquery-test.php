...
class Acf_Helper_JQuery_Test extends WP_UnitTestCase {
	...
	/**
	 * Testing get_acf_time_picker_field
	 */

	/**
	 * Test if getting acf date time picker field return expected results
	 */
	function test_get_acf_time_picker_field() {
		...
		$field 		  = $plugin['acf-helper/jquery']->get_acf_time_picker_field( 'foo', 'Foo' );
		$field_filled = $plugin['acf-helper/jquery']->get_acf_time_picker_field( 'bar', 'Bar', array(
			'instructions' => 'Choose time',
			'required' => 1,
			'conditional_logic' => 0,
			'wrapper' => array(
	 ...
	 * Test if getting acf date time picker with null as $name value throw expected exception
	 */
	function test_get_acf_time_picker_field_throwing_exception_when_name_is_null() {
		...
		$plugin['acf-helper/jquery']->get_acf_time_picker_field( null, 'Foo' );
	}

	/**
	 * Test if getting acf date time picker with integer as $name value throw expected exception
	 */
	function test_get_acf_time_picker_field_throwing_exception_when_name_is_integer() {
		...
		$plugin['acf-helper/jquery']->get_acf_time_picker_field( 1, 'Foo' );
	}

	/**
	 * Test if getting acf date time picker with null as $label value throw expected exception
	 */
	function test_get_acf_time_picker_field_throwing_exception_when_label_is_null() {
		...
		$plugin['acf-helper/jquery']->get_acf_time_picker_field( 'bar', null );
	}

	/**
	 * Test if getting acf date time picker with integer as $label value throw expected exception
	 */
	function test_get_acf_time_picker_field_throwing_exception_when_label_is_integer() {
		...
		$plugin['acf-helper/jquery']->get_acf_time_picker_field( 'bar', 1.10 );
	}

	/**
	 * Testing get_acf_color_picker_field
	 */

	/**
	 * Test if getting acf date time picker field return expected results
	 */
	function test_get_acf_color_picker_field() {
		...
		$field 		  = $plugin['acf-helper/jquery']->get_acf_color_picker_field( 'foo', 'Foo' );
		$field_filled = $plugin['acf-helper/jquery']->get_acf_color_picker_field( 'bar', 'Bar', array(
			'instructions' => 'Choose color',
			'required' => 1,
			'conditional_logic' => 0,
			'wrapper' => array(
	 ...
	 * Test if getting acf date time picker with null as $name value throw expected exception
	 */
	function test_get_acf_color_picker_field_throwing_exception_when_name_is_null() {
		...
		$plugin['acf-helper/jquery']->get_acf_color_picker_field( null, 'Foo' );
	}

	/**
	 * Test if getting acf date time picker with integer as $name value throw expected exception
	 */
	function test_get_acf_color_picker_field_throwing_exception_when_name_is_integer() {
		...
		$plugin['acf-helper/jquery']->get_acf_color_picker_field( 1, 'Foo' );
	}

	/**
	 * Test if getting acf date time picker with null as $label value throw expected exception
	 */
	function test_get_acf_color_picker_field_throwing_exception_when_label_is_null() {
		...
		$plugin['acf-helper/jquery']->get_acf_color_picker_field( 'bar', null );
	}

	/**
	 * Test if getting acf date time picker with integer as $label value throw expected exception
	 */
	function test_get_acf_color_picker_field_throwing_exception_when_label_is_integer() {
		...
		$plugin['acf-helper/jquery']->get_acf_color_picker_field( 'bar', 1.10 );
	}
}
