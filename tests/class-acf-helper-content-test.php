...
class Acf_Helper_Content_Test extends WP_UnitTestCase {
	...
	/**
	 * Testing get_acf_gallery_field
	 */

	/**
	 * Test if getting acf gallery field return expected results
	 */
	function test_get_acf_gallery_field() {
		...
		$expected_filled = array(
			...
			'name' => 'bar',
			'type' => 'gallery',
			'instructions' => 'Upload some gallery',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '50%',
		...
		$field 		  = $plugin['acf-helper/content']->get_acf_gallery_field( 'foo', 'Foo' );
		$field_filled = $plugin['acf-helper/content']->get_acf_gallery_field( 'bar', 'Bar', array(
			'instructions' => 'Upload some gallery',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
	...
	/**
	 * Test if getting acf gallery with null as $name value throw expected exception
	 */
	function test_get_acf_gallery_field_throwing_exception_when_name_is_null() {
		...
		$plugin['acf-helper/content']->get_acf_gallery_field( null, 'Foo' );
	}

	/**
	 * Test if getting acf gallery with integer as $name value throw expected exception
	 */
	function test_get_acf_gallery_field_throwing_exception_when_name_is_integer() {
		...
		$plugin['acf-helper/content']->get_acf_gallery_field( 1, 'Foo' );
	}

	/**
	 * Test if getting acf gallery with null as $label value throw expected exception
	 */
	function test_get_acf_gallery_field_throwing_exception_when_label_is_null() {
		...
		$plugin['acf-helper/content']->get_acf_gallery_field( 'bar', null );
	}

	/**
	 * Test if getting acf gallery with integer as $label value throw expected exception
	 */
	function test_get_acf_gallery_field_throwing_exception_when_label_is_integer() {
		...
		$plugin['acf-helper/content']->get_acf_gallery_field( 'bar', 1 );
	}
}
