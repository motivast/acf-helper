...
class Acf_Helper_Relational_Test extends WP_UnitTestCase {
	...
	/**
	 * Testing get_acf_user_field
	 */

	/**
	 * Test if getting acf user field return expected results
	 */
	function test_get_acf_user_field() {
		...
		$field 		  = $plugin['acf-helper/relational']->get_acf_user_field( 'foo', 'Foo' );
		$field_filled = $plugin['acf-helper/relational']->get_acf_user_field( 'bar', 'Bar', array(
			'instructions' => 'Choose any user',
			'required' => 1,
			'conditional_logic' => 0,
			'wrapper' => array(
	...
	/**
	 * Test if getting acf user with null as $name value throw expected exception
	 */
	function test_get_acf_user_field_throwing_exception_when_name_is_null() {
		...
		$plugin['acf-helper/relational']->get_acf_user_field( null, 'Foo' );
	}

	/**
	 * Test if getting acf user with integer as $name value throw expected exception
	 */
	function test_get_acf_user_field_throwing_exception_when_name_is_integer() {
		...
		$plugin['acf-helper/relational']->get_acf_user_field( 1, 'Foo' );
	}

	/**
	 * Test if getting acf user with null as $label value throw expected exception
	 */
	function test_get_acf_user_field_throwing_exception_when_label_is_null() {
		...
		$plugin['acf-helper/relational']->get_acf_user_field( 'bar', null );
	}

	/**
	 * Test if getting acf user with integer as $label value throw expected exception
	 */
	function test_get_acf_user_field_throwing_exception_when_label_is_integer() {
		...
		$plugin['acf-helper/relational']->get_acf_user_field( 'bar', 1.10 );
	}
}
