...
class Acf_Helper extends ACF_Helper_Container {
	...
	private function load_dependencies() {
		...
		/**
		 * Require layout acf helper functions
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'inc/class-acf-helper-layout.php';
		...
		$this['acf-helper/layout']      = new Acf_Helper_Layout( $this );
